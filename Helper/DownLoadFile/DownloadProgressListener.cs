...
namespace Gac
{
    public class DownloadProgressListener : IDownloadProgressListener
    {
        ...
        public void OnDownloadSize(long size)
        {
            ...
            else
            {
                ...
                int Seconds = (int)lastdate.Subtract(DateTime.Now).TotalSeconds;
                if (Seconds>0)
                {
                    downMsg.Speed /= Seconds;
                }
            }
    ...
    public class DownMsg
    {
        ...
        private bool _ResumeBrokenTransfer = true;
        public int Length
        {
            get
            {
        ...
        public bool ResumeBrokenTransfer
        {
            get
            {
                return _ResumeBrokenTransfer;
            }

            set
            {
                _ResumeBrokenTransfer = value;
            }
        }
