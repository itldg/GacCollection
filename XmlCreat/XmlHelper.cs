...
";
                ...
                else
                {
                    if (type == "Value")
                    {
                        string tempstr = "    private   List<string>   _" + name + @"  =   new List<string>();" + (string.IsNullOrEmpty(value) ? "" : @"
     /// <summary>
     /// 参考值：" + value + @" 
     /// </summary>") + @"
...
";
                    ...
                    {
                        string tempstr = "    private   List<" + name + ">   _" + name + @"Collection   =   new List<" + name + @">();
