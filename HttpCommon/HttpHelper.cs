...
namespace Gac_Stop
{
    ...
    public class HttpHelper
    {
        ...
        private long LengthAgo = 0;
        private DateTime datastart = DateTime.Now;
        #endregion

        #region Public
        public HttpResult GacGetHtml()
        {
            //返回参数
        ...
        {
            double s = DateTime.Now.Subtract(datastart).TotalSeconds;
            return LengthAgo / s;
        }
        /// <summary>
        /// 获取数据的并解析的方法
        ...
        /// <param name="item"></param>
        /// <param name="result"></param>
        private void LdgGetData(HttpResult result)
        {
            #region base
            //获取StatusCode
            result.StatusCode = response.StatusCode;
        ...
        public void SetRequest(HttpItem item)
        {
            // 验证证书
            SetCer(item);
