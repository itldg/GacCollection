...
namespace StanSoft
{
    ...
    public class Html2Article
    {
        ...
        // 用于确定文章结束的字符数
        private  int _endLimitCharCount = 20;
        ...
        /// <returns></returns>
        private  string FormatTag(Match match)
        {
        ...
        /// <param name="html"></param>
        /// <returns></returns>
        private  DateTime GetPublishDate(string html)
        {
        ...
        private  void GetContent(string bodyText, out string content, out string contentWithTags)
        {
